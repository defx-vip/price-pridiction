...
/**
 * @author 0mllwntrmt3
 * @title DEFX Protocol V8888 Options Manager Contract
...
contract OptionsManager is
    IOptionsManager,
    ERC721("DEFX V8888 Options (Tokenized)", "HOT8888"),
    AccessControl
{
    bytes32 public constant DEFX_POOL_ROLE = keccak256("DEFX_POOL_ROLE");
