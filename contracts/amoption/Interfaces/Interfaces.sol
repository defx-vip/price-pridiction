 ...
 * DEFX
 * Copyright (C) 2021 DEFX Protocol
 *
...
// /**
//  * @author 0mllwntrmt3
//  * @title DEFX Protocol V8888 Interface
 ...
 **/
interface IDEFXPool is IERC721, IPriceCalculator {
     ...
     *   is distributed among the DEFX staking participants
...
/**
 * @notice The interface for the contract that stakes DEFX tokens
 *   through buying microlots (any amount of DEFX tokens per microlot)
 *   and staking lots (888,000 DEFX per lot), accumulates the staking
