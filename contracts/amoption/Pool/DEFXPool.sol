...
/**
 * @author 0mllwntrmt3
 * @title DEFX Protocol V8888 Main Pool Contract
    ...
    ReentrancyGuard
{
    ...
    IDEFXStaking public settlementFeeRecipient;
    ...
    constructor(
        ...
        IDEFXStaking _settlementFeeRecipient,
    ...
    {
        return
            interfaceId == type(IDEFXPool).interfaceId ||
    ...
    function _calculateTotalPremium(
        ...
        require(
            ...
            "DEFXPool: The option's price is too low"
        );
    }
     ...
     **/
    function setSettlementFeeRecipient(IDEFXStaking recipient)
        external
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
