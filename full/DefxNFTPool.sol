...
// File: contracts/nft/DefxNFTPool.sol
...
contract DefxNFTPool {
    ...
    function pendingToken(address _user) external view returns(uint256 pendingToken1, uint256 pendingToken2)  {
        ...
        uint256 startToken1Reward = detToken1PerBlock.mul(multiplier);
        uint256 startToken2Reward = detToken2PerBlock.mul(multiplier);
        uint256 _accDetToken1PerShare = accDetToken1PerShare.add(startToken1Reward.mul(1e12).div(totalAllocPoint1));
        uint256 _accDetToken2PerShare = accDetToken2PerShare.add(startToken2Reward.mul(1e12).div(totalAllocPoint2));
