...
contract DFVToken is Ownable {
    ...
    uint128 public MAX_UINT112 = 5192296858534827628530496329220095;
    ...
    // ============ Mint & Redeem & Donate ============
    function mintToUser(uint256 dftAmount, address to, address superiorAddress) external {
        require(
        ...
        if (user.superior == address(0)) {
            require(
                superiorAddress == _dftTeam || userInfo[superiorAddress].superior != address(0),
